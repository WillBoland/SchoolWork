...
public class GraphTest {
    ...
    /*
    ----------------------------------------------------------------------------------
    THIS IS MY GRAPH FOR SUBMISSION
    ----------------------------------------------------------------------------------
        ----------------------------------------------------------------------------------
    THIS IS MY GRAPH FOR SUBMISSION
    ----------------------------------------------------------------------------------
    ...
    @Test
    public void myTestGraph() {
        //first line
        Item pp1 = new Item("A", 0);
        Item pp2 = new Item("B", 0);
        Item pp3 = new Item("C", 0);
        Item pp4 = new Item("D", 0);
        Item pp5 = new Item("E", 0);

        //Second line
        Item pp6 = new Item("F", 0);
        Item pp7 = new Item("G", 0);
        Item pp8 = new Item("H", 0);

        //Last Line
        Item pp9 = new Item("I", 0);
        Item pp10 = new Item("J", 0);
        Item pp11 = new Item("K", 0);

        ArrayList<Item> nodes = new ArrayList<>(Arrays.asList(pp1, pp2, pp3, pp4, pp5, pp6, pp7, pp8, pp9, pp10, pp11));

        Hashtable<Item, ArrayList<Item>> neighbors = new Hashtable<>();
        neighbors.put(pp1, new ArrayList<>());
        neighbors.put(pp2, new ArrayList<>(Arrays.asList(pp1, pp3)));
        neighbors.put(pp3, new ArrayList<>(Arrays.asList(pp2, pp4)));
        neighbors.put(pp4, new ArrayList<>(Arrays.asList(pp3, pp5)));
        neighbors.put(pp5, new ArrayList<>(Arrays.asList(pp4, pp6)));
        neighbors.put(pp6, new ArrayList<>(Arrays.asList(pp5, pp7)));
        neighbors.put(pp7, new ArrayList<>(Arrays.asList(pp6, pp8)));
        neighbors.put(pp8, new ArrayList<>(Arrays.asList(pp7, pp9)));
        neighbors.put(pp9, new ArrayList<>(Arrays.asList(pp8, pp10)));
        neighbors.put(pp10, new ArrayList<>(Arrays.asList(pp9, pp11)));
        neighbors.put(pp11, new ArrayList<>(Arrays.asList(pp10)));

        Edge e1 = new Edge(pp2, pp1);
        Edge e2 = new Edge(pp3, pp2);
        Edge e3 = new Edge(pp4, pp3);
        Edge e4 = new Edge(pp5, pp4);
        Edge e5 = new Edge(pp6, pp5);
        Edge e6 = new Edge(pp7, pp6);
        Edge e7 = new Edge(pp8, pp7);
        Edge e8 = new Edge(pp9, pp8);
        Edge e9 = new Edge(pp10, pp9);
        Edge e10 = new Edge(pp11, pp10);
    ...
    public void testGraph1() {
        Item pp1 = new Item("A", 0);
        Item pp2 = new Item("B", 0);
        ArrayList<Item> nodes = new ArrayList<>(Arrays.asList(pp1, pp2));
