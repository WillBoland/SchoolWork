...
public class SeamCarvingTest {
    ...
    @Test
    public void cutBarney () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("Barney.jpg");
        int bound = sc.getWidth() * 1 / 3;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("Barney-cut.jpg");
    }

    @Test
    public void cutBaby () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("Baby.jpg");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("Baby-cut.jpg");
    }

    @Test
    public void cutHappy () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("Happy.jpg");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("Happy-cut.jpg");
    }

    @Test
    public void cutTT () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("TT.jpg");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
        ...
        sc.writeImage("TT-cut.jpg");
    }

    @Test
    public void cut_Erin3 () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("Erin3.jpg");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("Erin3-cut.jpg");
    }

    @Test
    public void doubleCutTT () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("TT-cut.jpg");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("Double-TT-cut.jpg");
    }

    @Test
    public void cutDumbledore () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("Dumbledore.jpg");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("Dumbledore-cut.jpg");
    }

    @Test
    public void cutGuy () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("Guy.jpg");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("Guy-cut.jpg");
    }

    @Test
    public void cutDrew () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("Drew.jpg");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("Drew-cut.jpg");
    }

    @Test
    public void cutEric () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("eric.jpg");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("eric-cut.jpg");
    }

    @Test
    public void cutErin2 () throws IOException {
        SeamCarving sc = new SeamCarving();
        sc.readImage("Erin2.PNG");
        int bound = sc.getWidth() * 1 / 2;
        for (int i=0; i<bound; i++) {
            System.out.printf("%d of %d%n", i+1, bound);
            sc.cutSeam();
        }
        sc.writeImage("Erin2-cut.PNG");
    }
     ...
     */
    @Test
    public void boardSeam() throws IOException {
        int H = 3; int W = 5;
    ...
    @Test
    public void boardSeam2() throws IOException {
        int H = 3; int W = 5;
        int red = Color.red.getRGB();
        int blue = Color.blue.getRGB();
        BufferedImage img = new BufferedImage(W,H,BufferedImage.TYPE_INT_ARGB);
        ...
        img.setRGB(3,2,blue);
        img.setRGB(4,2,red);
        ImageIO.write(img, "png", new File("board2.png"));
    ...
    @Test
    public void boardSeam3() throws IOException {
        int H = 3; int W = 5;
        int red = Color.red.getRGB();
        int blue = Color.blue.getRGB();
        BufferedImage img = new BufferedImage(W,H,BufferedImage.TYPE_INT_ARGB);
        ...
        img.setRGB(3,2,blue);
        img.setRGB(4,2,red);
        ImageIO.write(img, "png", new File("board3.png"));
