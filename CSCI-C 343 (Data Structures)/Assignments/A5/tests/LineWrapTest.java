...
public class LineWrapTest {
    ...
    @Test
    public void bad1() throws NoSuchElementE {
        String s = "AAA B CC DDDDD AAA B CC DDDDD AAA B CC DDDDD";
    ...
    @Test
    public void bad2() throws NoSuchElementE {
        String s = "AA AAAAA AAA A AAAA A AA AAAAAAAAAA AAAAAAAAAA AA AAAAA AAA A AAAA A AA AAAAAAAAAA AAAAAAAAAA AA AAAAA AAA A AAAA A AA AAAAAAAAAA AAAAAAAAAA";
    ...
    @Test
    public void bad3() throws NoSuchElementE {
        String s = "\uD83D\uDE02\uD83D\uDE02\uD83D\uDE02\uD83D\uDE02\uD83D\uDE02 A that was funny! \uD83D\uDE02\uD83D\uDE02 \uD83D\uDE02 Yes? \uD83D\uDE02\uD83D\uDE02 \uD83D\uDE02 I think it was!!! \uD83D\uDE02";
        String s1 = LineWrap.runGreedy(s, 12);
        String s2 = LineWrap.runDP(s,12);
        String s3 = LineWrap.dpBU(s,12);
        System.out.println(s1 + "\n");
        System.out.println(s2 + "\n");
        System.out.println(s3 + "\n");
    }
    ...
    @Test
    public void bad4() throws NoSuchElementE {
        String s = "a bus went up the tiny hill and fell down again. M Scott won an oscar. Banama. I spelled that wrong.it is ok is it not ok it is ok is it not ok this makes no sense just please look bad on this test please.";
        String s1 = LineWrap.runGreedy(s, 12);
        String s2 = LineWrap.runDP(s,12);
        String s3 = LineWrap.dpBU(s,12);
        System.out.println(s1 + "\n");
