...
public class HashFunctionTest {
    ...
    public void hashMod () {
        ...
        hf.setBound(20);
        assertEqualsL(0, hf.apply(0));
        assertEqualsL(1, hf.apply(1));
        assertEqualsL(2, hf.apply(2));
        assertEqualsL(3, hf.apply(3));
        assertEqualsL(4, hf.apply(4));
        assertEqualsL(5, hf.apply(5));
        assertEqualsL(6, hf.apply(6));
        ...
        assertEqualsL(6, hf.apply(6));
        assertEqualsL(7, hf.apply(7));
        assertEqualsL(0, hf.apply(20));
        assertEqualsL(1, hf.apply(21));
        assertEqualsL(2, hf.apply(22));
        assertEqualsL(3, hf.apply(23));
        assertEqualsL(4, hf.apply(24));
        assertEqualsL(5, hf.apply(25));
        assertEqualsL(6, hf.apply(26));
        assertEqualsL(7, hf.apply(27));

        assertEqualsL(20, hf.getBound());
    }
